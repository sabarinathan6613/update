const url = "https://tdwcenpafrpwhnzswlou.supabase.co/rest/v1/email_configuration?limit=1";
const headers = {
...
fetch(url, { headers })
  .then(res => {
    console.log("email_configuration status:", res.status);
    return res.text();
  })
  .then(text => console.log("email_configuration body:", text))
